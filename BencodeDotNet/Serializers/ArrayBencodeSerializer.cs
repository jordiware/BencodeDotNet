...
public sealed class ArrayBencodeSerializer<TType> : ReferenceTypeBencodeSerializer<TType[], Blist>
{
    ...
    /// <summary>
    /// Asynchronously serializes an array of values to the provided
    /// <see cref="PipeWriter"/> in Bencode list format.
    /// </summary>
    /// <param name="input">
    /// The array of values to serialize. Cannot be <see langword="null"/>.
    /// </param>
    /// <param name="writer">
    ...
    /// </returns>
    /// <remarks>
    /// The method writes a Bencode list ('l' ... 'e') and serializes each non-null
    /// element using the resolved serializer for <typeparamref name="TType"/>.  
    /// <see langword="null"/> elements in the array are skipped and produce no output.
    /// </remarks>
